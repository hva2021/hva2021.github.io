function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Rolling_Ball.loader.js";
		var config = {
        dataUrl: buildUrl + "/Rolling_Ball.data",
        frameworkUrl: buildUrl + "/Rolling_Ball.framework.js",
        codeUrl: buildUrl + "/Rolling_Ball.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Rolling Ball",
        productVersion: "1.0",
      };
